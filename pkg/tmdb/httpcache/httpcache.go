// Copied from https://github.com/gohugoio/httpcache/blob/d62773ca3b8d72fe53e88e00d3831ccaca8b1ffc/httpcache.go
// Changed:
//   - fixed responses not being cached, due to absence of EOF error on body read in cachingReadCloser.Read
//   - changed cachedResponse to return false when no cache entry is found
//   - added debug logs for cache hit and miss
//
